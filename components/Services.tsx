...
const servicesData = [
  ...
  {
    title: 'Brindes',
    desc: 'Nós temos uma grande variedade de brindes personalizados para atender a todas as necessidades. Seja para presentear clientes, celebrar datas comemorativas ou premiar funcionários, temos opções para todos os gostos.',
    icon: (
      <svg className="w-full h-full text-white" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    title: 'Têxtil',
    desc: 'Descubra a versatilidade e qualidade da nossa linha têxtil, que abrange camisetas, uniformes e bonés personalizados, incluindo camisetas para eventos. Seja para vestir sua equipe com estilo e profissionalismo ou criar lembranças memoráveis.',
    icon: (
      <svg className="w-full h-full text-white" viewBox="0 0 24 24" fill="currentColor">
        <path d="M7 2v4h10V2H7zm11 7c-1.66 0-3-1.34-3-3V5h2v1c0 .55.45 1 1 1s1-.45 1-1V5h2v1c0 1.66-1.34 3-3 3zm-9 0c-1.66 0-3-1.34-3-3V5h2v1c0 .55.45 1 1 1s1-.45 1-1V5h2v1c0 1.66-1.34 3-3 3zM4 12c0-1.1.9-2 2-2h12c1.1 0 2 .9 2 2v7c0 1.1-.9 2-2 2H6c-1.1 0-2-.9-2-2v-7z" />
      </svg>
    )
  }
];
